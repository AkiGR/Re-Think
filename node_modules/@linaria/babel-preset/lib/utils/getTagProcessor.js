...
function getBuilderForIdentifier(path, imports, filename, options) {
  ...
  const importedType = imports.some(i => i.type === 'esm') ? 'es6' : 'commonjs';
  const astService = {
    ..._core.types,
    ...
    addNamedImport: (name, importedSource, nameHint) => (0, _helperModuleImports.addNamed)(path, name, importedSource, {
      importedType,
      nameHint
    })
  };
