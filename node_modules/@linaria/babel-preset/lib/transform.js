...
function syncStages(originalCode, options, prepareStageResults, babelConfig, cache, eventEmitter) {
  ...
  const evalStageResult = (0, _eval.default)(cache, prepareStageResults.map(r => r.code), options);
  eventEmitter === null || eventEmitter === void 0 ? void 0 : eventEmitter({
