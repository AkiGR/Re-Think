...
function collector(babel, options) {
  ...
  return {
    ...
    pre(file) {
      ...
      const prepareStageResults = (0, _prepareForEval.prepareForEvalSync)(babel, cache, _utils.syncResolve, entryPoint, {
      ...
      const evalStageResult = (0, _eval.default)(cache, prepareStageResults.map(r => r.code), {
